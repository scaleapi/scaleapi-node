...
var SCALE_ENDPOINT = 'http://localhost:3000/v1/';
...
ScaleClient.prototype.tasks = function(params, cb) {
  var allowedKwargs = ['start_time', 'end_time', 'status', 'type', 'project', 'batch', 'limit', 'offset', 'completed_after', 'completed_before'];
