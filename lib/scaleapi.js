...
ScaleClient.prototype.fetch_task = function(task_id, cb) {
  getrequest('task/' + task_id, this.apikey, {}, (err, json) => {
    if (cb) cb(err, new Task(this, json));
  });
};

ScaleClient.prototype.cancel_task = function(task_id, cb) {
  getrequest('task/' + task_id + '/cancel', this.apikey, {}, (err, json) => {
    if (cb) cb(err, new Task(this, json));
  });
};
...
ScaleClient.prototype.tasks = function(params, cb) {
  ...
  if (allowed_kwargs.limit === undefined) allowed_kwargs.limit = DEFAULT_LIMIT;

  if (allowed_kwargs.offset === undefined) allowed_kwargs.offset = DEFAULT_OFFSET;
...
ScaleClient.prototype.create_categorization_task = function(params, cb) {
...
ScaleClient.prototype.create_transcription_task = function(params, cb) {
...
ScaleClient.prototype.create_phonecall_task = function(params, cb) {
...
ScaleClient.prototype.create_comparison_task = function(params, cb) {
...
ScaleClient.prototype.create_annotation_task = function(params, cb) {
...
ScaleClient.prototype.create_datacollection_task = function(params, cb) {
...
ScaleClient.prototype.create_audiotranscription_task = function(params, cb) {
